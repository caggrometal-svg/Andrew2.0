...
export interface ManagedAsset extends AssetMetadata {
  source: Blob | File;
...
export interface Renderer {
  ...
  render(): void;
  deleteAssetTexture(assetId: UUID): void;
  dispose(): void;
}
...
export interface AssetManager {
  load(file: File, options?: AssetLoadOptions): Promise<AssetLoadResult>;
  remove(id: UUID): void;
  get(id: UUID): ManagedAsset | undefined;
  clear(): void;
  dispose(): void;
}
...
export interface VideoExporter {
  export(options?: VideoExportOptions, callbacks?: VideoExportCallbacks): Promise<VideoExportResult>;
  cancel(): void;
